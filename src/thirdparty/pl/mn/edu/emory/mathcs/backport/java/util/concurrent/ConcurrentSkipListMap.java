...
import pl.mn.edu.emory.mathcs.backport.java.util.AbstractMap;
import pl.mn.edu.emory.mathcs.backport.java.util.NavigableMap;
...
public class ConcurrentSkipListMap extends AbstractMap
    ...
    final void initialize() {
        ...
        randomSeed = ((int) Utils.nanoTime()) | 1; // ensure nonzero
     ...
     */
    SimpleImmutableEntry getNear(Object kkey, int rel) {
        for (;;) {
    ...
    class EntrySet extends AbstractSet {
        ...
        public Object[] toArray() {
            ...
            for (Iterator itr = this.iterator(); itr.hasNext();) {
                Map.Entry e = (Map.Entry)itr.next();
                c.add(new SimpleEntry(e.getKey(),
                                                  e.getValue()));
            }
            return c.toArray();
        }
