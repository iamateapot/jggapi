...
package pl.mn.edu.emory.mathcs.backport.java.util.concurrent.helpers;

import java.security.AccessController;
import java.security.PrivilegedAction;

import pl.mn.edu.emory.mathcs.backport.java.util.concurrent.TimeUnit;
import pl.mn.edu.emory.mathcs.backport.java.util.concurrent.locks.Condition;
...
public final class Utils {
     ...
     * pl.mn.edu.emory.mathcs.backport.java.util.concurrent.locks.Condition#signal}
     * method for this
     * <tt>Condition</tt> and the current thread happens to be chosen as the
     * thread to be awakened; or
     * <li>Some other thread invokes the {@link
     * pl.mn.edu.emory.mathcs.backport.java.util.concurrent.locks.Condition#signalAll}
     * method for this
     * <tt>Condition</tt>; or
